...
tabreadlin~.class.sources	:= Classes/Source/tabreadlin~.c $(A_Math)
...
rotate_e~.class.sources 	:= Classes/Aliases/rotate_e~.c $(A_Math) $(vec3)
rotate_a~.class.sources  	:= Classes/Aliases/rotate_a~.c $(A_Math) $(vec3)
rotate_p~.class.sources 	:= Classes/Aliases/rotate_p~.c $(A_Math) $(vec3)
...
cut_mix~.class.sources      := Classes/Source/cut_mix~.c $(A_Math) $(cut)
cut_weights~.class.sources  := Classes/Source/cut_weights~.c $(A_Math) $(cut)
